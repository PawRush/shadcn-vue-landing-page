...
export class PipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    this.pipeline = new pipelines.CodePipeline(this, "Pipeline", {
      pipelineName: "ShadcnVuePipeline",
      selfMutation: true,
    ...
    new FrontendStack(deployStage, "ShadcnVueFrontend-prod", {
      stackName: "ShadcnVueFrontend-prod",
      environment: "prod",
    ...
    new cdk.CfnOutput(this, "PipelineConsoleUrl", {
      value: `https://${this.region}.console.aws.amazon.com/codesuite/codepipeline/pipelines/ShadcnVuePipeline/view`,
