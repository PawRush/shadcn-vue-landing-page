...
```bash
# Rollback
cd infra && npx cdk destroy "ShadcnVueFrontend-preview-kamielw" --region eu-central-1
...
Progress: Completed full deployment - analyzed codebase, generated CDK infrastructure, deployed to AWS
Next: Update README.md and finalize documentation
